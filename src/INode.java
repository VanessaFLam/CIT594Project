...
public interface INode {
    ...
    /**
     * Getter for node index. Node index is the vertex number of this node in the
     * graph
     * 
    ...
    /**
     * Setter for node index. Node index is the vertex number of this node in the
     * graph
     * 
    ...
    /**
     * Getter for the wiki ID of the article represented by this node
     * 
    ...
    /**
     * Setter for the wiki ID of the article represented by this node
     * 
    ...
    /**
     * Getter for the name of the wiki article represented by this node
     * 
    ...
    /**
     * Setter for the name of the wiki article represented by this node
     * 
